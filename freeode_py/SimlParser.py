...
class Node(object):
    ...
    def __init__(self, nodeType, children=[], loc=None, toks=[]):
        ...
        self.nodeType = nodeType   # type string
        #self.parent = None
        self.children = children # list of children
        self.loc  = loc          # the location in the program
        self.toks = toks         # the original tokens


    def __repr__(self):
        className = self.__class__.__name__
        typeStr = repr(self.nodeType)
        childStr = repr(self.children)

        #if loc and toks have their default value, don't print them
        if self.loc == None:
            locStr = ''
        else:
        ...
        if self.toks == []:
            ...
            tokStr = repr(self.toks)

        reprStr = className  + "(" + typeStr + "," + childStr + ")"
        return reprStr
