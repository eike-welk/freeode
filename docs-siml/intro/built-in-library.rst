...
.. function::  printc(* args, area="", end="\\n") -> NoneType
    ...
    **ARGUMENTS**
    ...
    area="" : :class:`String`
        Only produce output when area is in global set of strings (debug areas).
        The special value "" means: print unconditionally.

        To enable debug areas use command line option ``--debug-area=area1,area2,...``
        of the compiler.
    ...
    **RETURNS**
    ...
    See also: :ref:`ifc-statement`, :function:`print`
...
.. function::  print(* args, area="", end="\\n") -> NoneType
    ...
    **ARGUMENTS**
    ...
    area="" : :class:`String`
        ...
        To enable debug areas use command line option ``--debug-area=area1,area2,...``
        of the generated program (or the compiler).
